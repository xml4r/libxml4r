...
Here we combine our usage of both the `libxml-ruby`, and `libxml-bindings` functions, which results in much smaller and more compact code. Its just a case of using the right tool for the right job.
