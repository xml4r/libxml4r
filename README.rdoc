...
Here we combine our usage of both the `libxml-ruby`, and `libxml-bindings` functions, which results in much smaller and more compact code. Its just a case of using the best tool for the job and spending the time to understand the libxml-ruby api.
...
Its well worth it to go back and visit all of the links on this page. The documentation to be found there is all absoloutely invaluable.
